...
| `bizum` | Bizum | Payment system | Glyph | Not bundled | Not configured | `payment-transfer` | Payment transfer glyph | Bizum official service references | Use project-owned transfer glyph until official usage is approved. |
| `vies` | VIES | EU VAT validation system | Glyph | Not bundled | Not configured | `tax-document` | Tax document glyph | European Commission VIES references | Use project-owned tax document glyph. |
| `europeanUnion` | European Union | Public institution | Glyph | Not bundled | Not configured | `government-portal` | Government portal glyph | European Union official site | Use project-owned public institution glyph until official usage is approved. |
| `gobiernoEspana` | Gobierno de España | Government portal | Glyph | Not bundled | Not configured | `government-portal` | Government portal glyph | La Moncloa and Administracion.gob.es official references | Use project-owned government portal glyph until official usage is approved. |
| `agenciaTributaria` | Agencia Tributaria | Tax authority | Glyph | Not bundled | Not configured | `tax-document` | Tax document glyph | Agencia Tributaria official site | Use project-owned tax document glyph until official usage is approved. |
| `seguridadSocialEspana` | Seguridad Social | Social security authority | Glyph | Not bundled | Not configured | `government-portal` | Government portal glyph | Seguridad Social official portal | Use project-owned government portal glyph until official usage is approved. |
| `bancoEspana` | Banco de España | Central bank | Glyph | Not bundled | Not configured | `central-bank` | Central bank glyph | Banco de España official site | Use project-owned central bank glyph until official usage is approved. |
| `correosEspana` | Correos | Postal authority | Glyph | Not bundled | Not configured | `postal` | Postal glyph | Correos official site | Use project-owned postal glyph until official usage is approved. |
