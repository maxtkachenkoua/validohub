...
const routes = [
  ...
  },
  {
    ...
    input: "textarea, input",
    sampleText: "Invalid",
    mustContain: ["MOD-97", "field breakdown", "Developer snapshot JSON"],
  },
  {
    path: "/en/tools/iban-generator/",
    input: "textarea, input",
    sampleText: "Bad country prefix",
    mustContain: ["Generated IBAN", "MOD-97", "Developer snapshot JSON"],
  },
  {
    path: "/en/tools/phone-e164-workbench/",
    input: "textarea, input",
    sampleText: "Wrong prefix",
    mustContain: ["E.164", "Field breakdown", "Developer snapshot JSON"],
  },
  {
    path: "/en/tools/postal-code-workbench/",
    input: "textarea, input",
    sampleText: "Invalid sample",
    mustContain: ["Postal", "Field breakdown", "Developer snapshot JSON"],
  },
  {
    path: "/en/tools/swift-bic-workbench/",
    input: "textarea, input",
    sampleText: "Bad country prefix",
    mustContain: ["BIC", "Field breakdown", "Developer snapshot JSON"],
  },
  {
    path: "/en/tools/mrz-passport-workbench/",
    input: "textarea, input",
    sampleText: "Invalid checksum",
    mustContain: ["MRZ", "Field breakdown", "Developer snapshot JSON"],
  },
  {
    path: "/en/tools/csv-locale-normalizer/",
    input: "textarea, input",
    sampleText: "Invalid row",
    mustContain: ["CSV", "Field breakdown", "Developer snapshot JSON"],
  },
  {
    path: "/en/tools/eu-vat-number-workbench/",
    input: "textarea, input",
    sampleText: "Bad country prefix",
    mustContain: ["VAT", "VIES", "Developer snapshot JSON"],
  },
  {
    path: "/en/tools/iso20022-sepa-inspector/",
    input: "textarea, input",
    sampleText: "Invalid XML",
    mustContain: ["ISO 20022", "Field breakdown", "Developer snapshot JSON"],
  },
  {
    path: "/en/tools/secret-pii-redactor/",
    input: "textarea, input",
    sampleText: "Secrets + PII",
    mustContain: ["Secret", "Redacted", "Developer snapshot JSON"],
  },
  {
    path: "/en/tools/locale-test-data-generator/",
    input: "textarea, input",
    sampleText: "Brazil CSV",
    mustContain: ["Locale", "Fixtures ready", "Developer snapshot JSON"],
  },
  {
    path: "/en/tools/webhook-signature-verifier/",
    input: "textarea, input",
    sampleText: "Invalid signature",
    mustContain: ["Webhook", "Signature mismatch", "Developer snapshot JSON"],
  },
  {
    path: "/en/tools/json-schema-workbench/",
    input: "textarea, input",
    sampleText: "Missing required",
    mustContain: ["JSON","Field breakdown","Developer snapshot JSON"],
  },
  {
    path: "/en/tools/openapi-inspector/",
    input: "textarea, input",
    sampleText: "Missing info",
    mustContain: ["OpenAPI","Field breakdown","Developer snapshot JSON"],
  },
  {
    path: "/en/tools/yaml-toml-workbench/",
    input: "textarea, input",
    sampleText: "Bad indent",
    mustContain: ["YAML","Field breakdown","Developer snapshot JSON"],
  },
  {
    path: "/en/tools/xml-xpath-workbench/",
    input: "textarea, input",
    sampleText: "Invalid XML",
    mustContain: ["XML","Field breakdown","Developer snapshot JSON"],
  },
  {
  ...
  },
  {
    ...
    mustContain: ["SQL","Field breakdown","Developer snapshot JSON"],
  },
  {
    path: "/en/tools/cron-expression-workbench/",
    input: "textarea, input",
    sampleText: "Invalid cron",
    mustContain: ["Cron","Field breakdown","Developer snapshot JSON"],
  },
  {
    path: "/en/tools/regex-explainer-generator/",
    input: "textarea, input",
    sampleText: "ReDoS risk",
    mustContain: ["Regex","Field breakdown","Developer snapshot JSON"],
  },
  {
    path: "/en/tools/date-timezone-workbench/",
    input: "textarea, input",
    sampleText: "Invalid date",
    mustContain: ["Date","Field breakdown","Developer snapshot JSON"],
  },
  {
    path: "/en/tools/color-contrast-token-workbench/",
    input: "textarea, input",
    sampleText: "Low contrast",
    mustContain: ["Color","Field breakdown","Developer snapshot JSON"],
  },
  {
    path: "/en/tools/markdown-mdx-inspector/",
    input: "textarea, input",
    sampleText: "Broken anchor",
    mustContain: ["Markdown","Field breakdown","Developer snapshot JSON"],
  },
  {
    path: "/en/tools/graphql-workbench/",
    input: "textarea, input",
    sampleText: "Bad variables",
    mustContain: ["GraphQL","Field breakdown","Developer snapshot JSON"],
  },
  {
    path: "/en/tools/email-domain-workbench/",
    input: "textarea, input",
    sampleText: "Invalid email",
    mustContain: ["Email","Field breakdown","Developer snapshot JSON"],
  },
  {
    path: "/en/tools/user-agent-client-hints-parser/",
    input: "textarea, input",
    sampleText: "Bot UA",
    mustContain: ["User-Agent","Field breakdown","Developer snapshot JSON"],
  },
  {
    path: "/en/tools/http-security-headers-inspector/",
    input: "textarea, input",
    sampleText: "Weak CORS",
    mustContain: ["HTTP","Field breakdown","Developer snapshot JSON"],
  },
  {
    path: "/en/tools/jwt-jwk-oauth-inspector/",
    input: "textarea, input",
    sampleText: "JWKS keys",
    mustContain: ["JWT","Field breakdown","Developer snapshot JSON"],
  },
  {
    path: "/en/tools/csp-builder-auditor/",
    input: "textarea, input",
    sampleText: "Unsafe CSP",
    mustContain: ["CSP","Field breakdown","Developer snapshot JSON"],
  },
  {
    path: "/en/tools/cookie-security-inspector/",
    input: "textarea, input",
    sampleText: "Weak cookie",
    mustContain: ["Cookie","Field breakdown","Developer snapshot JSON"],
  },
  {
    path: "/en/tools/url-redirect-utm-workbench/",
    input: "textarea, input",
    sampleText: "Campaign URL",
    mustContain: ["URL","Field breakdown","Developer snapshot JSON"],
  },
  {
  ...
  },
  {
    ...
    mustContain: ["JSONPath","Field breakdown","Developer snapshot JSON"],
  },
  {
    path: "/en/tools/avro-protobuf-schema-inspector/",
    input: "textarea, input",
    sampleText: "Protobuf schema",
    mustContain: ["Avro","Field breakdown","Developer snapshot JSON"],
  },
  {
    path: "/en/tools/ndjson-log-parser-workbench/",
    input: "textarea, input",
    sampleText: "Malformed line",
    mustContain: ["NDJSON","Field breakdown","Developer snapshot JSON"],
  },
  {
    path: "/en/tools/diff-patch-workbench/",
    input: "textarea, input",
    sampleText: "Text diff",
    mustContain: ["Diff","Field breakdown","Developer snapshot JSON"],
  },
  {
    path: "/en/tools/base64-binary-payload-inspector/",
    input: "textarea, input",
    sampleText: "JWT part",
    mustContain: ["Base64","Field breakdown","Developer snapshot JSON"],
  },
  {
    path: "/en/tools/secret-scanner-workbench/",
    input: "textarea, input",
    sampleText: "Clean config",
    mustContain: ["Secret","Field breakdown","Developer snapshot JSON"],
  },
  {
    path: "/en/tools/tls-certificate-inspector/",
    input: "textarea, input",
    sampleText: "Expired dates",
    mustContain: ["TLS","Field breakdown","Developer snapshot JSON"],
  },
  {
    path: "/en/tools/dns-record-workbench/",
    input: "textarea, input",
    sampleText: "Weak SPF",
    mustContain: ["DNS","Field breakdown","Developer snapshot JSON"],
  },
  {
    path: "/en/tools/spf-dmarc-builder/",
    input: "textarea, input",
    sampleText: "Reject policy",
    mustContain: ["SPF","Field breakdown","Developer snapshot JSON"],
  },
  {
    path: "/en/tools/sri-hash-integrity-inspector/",
    input: "textarea, input",
    sampleText: "Integrity attr",
    mustContain: ["SRI","Field breakdown","Developer snapshot JSON"],
  },
  {
    path: "/en/tools/kubernetes-yaml-inspector/",
    input: "textarea, input",
    sampleText: "Risky deployment",
    mustContain: ["Kubernetes","Field breakdown","Developer snapshot JSON"],
  },
  {
    path: "/en/tools/dockerfile-auditor/",
    input: "textarea, input",
    sampleText: "Root latest",
    mustContain: ["Dockerfile","Field breakdown","Developer snapshot JSON"],
  },
  {
    path: "/en/tools/github-actions-workflow-inspector/",
    input: "textarea, input",
    sampleText: "Danger trigger",
    mustContain: ["GitHub","Field breakdown","Developer snapshot JSON"],
  },
  {
    path: "/en/tools/terraform-hcl-plan-inspector/",
    input: "textarea, input",
    sampleText: "Destroy risk",
    mustContain: ["Terraform","Field breakdown","Developer snapshot JSON"],
  },
  {
    path: "/en/tools/nginx-apache-config-inspector/",
    input: "textarea, input",
    sampleText: "Proxy risk",
    mustContain: ["NGINX","Field breakdown","Developer snapshot JSON"],
  },
  {
    path: "/en/tools/prompt-injection-scanner/",
    input: "textarea, input",
    sampleText: "Injection doc",
    mustContain: ["Prompt","Field breakdown","Developer snapshot JSON"],
  },
  {
    path: "/en/tools/rag-chunking-workbench/",
    input: "textarea, input",
    sampleText: "Long doc",
    mustContain: ["RAG","Field breakdown","Developer snapshot JSON"],
  },
  {
    path: "/en/tools/vector-metadata-schema-inspector/",
    input: "textarea, input",
    sampleText: "PII metadata",
    mustContain: ["Vector","Field breakdown","Developer snapshot JSON"],
  },
  {
    path: "/en/tools/jsonl-finetune-dataset-inspector/",
    input: "textarea, input",
    sampleText: "Bad JSONL",
    mustContain: ["JSONL","Field breakdown","Developer snapshot JSON"],
  },
  {
    path: "/en/tools/eval-dataset-builder/",
    input: "textarea, input",
    sampleText: "Thin eval",
    mustContain: ["Eval","Field breakdown","Developer snapshot JSON"],
  },
  {
    path: "/en/tools/rest-error-contract-inspector/",
    input: "textarea, input",
    sampleText: "Thin error",
    mustContain: ["REST","Field breakdown","Developer snapshot JSON"],
  },
  {
    path: "/en/tools/idempotency-key-workbench/",
    input: "textarea, input",
    sampleText: "Weak key",
    mustContain: ["Idempotency","Field breakdown","Developer snapshot JSON"],
  },
  {
    path: "/en/tools/rate-limit-header-inspector/",
    input: "textarea, input",
    sampleText: "Missing retry",
    mustContain: ["Rate","Field breakdown","Developer snapshot JSON"],
  },
  {
    path: "/en/tools/cors-policy-workbench/",
    input: "textarea, input",
    sampleText: "Wildcard creds",
    mustContain: ["CORS","Field breakdown","Developer snapshot JSON"],
  },
  {
    path: "/en/tools/websocket-sse-message-inspector/",
    input: "textarea, input",
    sampleText: "Bad JSON frame",
    mustContain: ["WebSocket","Field breakdown","Developer snapshot JSON"],
  },
  {
    path: "/en/tools/html-meta-seo-inspector/",
    input: "textarea, input",
    sampleText: "SEO thin",
    mustContain: ["HTML","Field breakdown","Developer snapshot JSON"],
  },
  {
    path: "/en/tools/accessibility-snapshot-inspector/",
    input: "textarea, input",
    sampleText: "A11Y risk",
    mustContain: ["Accessibility","Field breakdown","Developer snapshot JSON"],
  },
  {
    path: "/en/tools/design-token-inspector/",
    input: "textarea, input",
    sampleText: "Duplicate tokens",
    mustContain: ["Design","Field breakdown","Developer snapshot JSON"],
  },
  {
    path: "/en/tools/source-map-stack-trace-parser/",
    input: "textarea, input",
    sampleText: "Missing release",
    mustContain: ["Source","Field breakdown","Developer snapshot JSON"],
  },
  {
    path: "/en/tools/browser-storage-inspector/",
    input: "textarea, input",
    sampleText: "Token storage",
    mustContain: ["Browser","Field breakdown","Developer snapshot JSON"],
  },
  // BEGIN global premium batch v4 audit routes
  {
    path: "/en/tools/oauth-oidc-flow-debugger/",
    input: "textarea, input",
    sampleText: "Implicit risk",
    mustContain: ["OAuth", "Field breakdown", "Developer snapshot JSON"],
  },
  {
    path: "/en/tools/jwt-risk-scanner/",
    input: "textarea, input",
    sampleText: "Weak claims",
    mustContain: ["JWT", "Field breakdown", "Developer snapshot JSON"],
  },
  {
    path: "/en/tools/jwks-rotation-inspector/",
    input: "textarea, input",
    sampleText: "Legacy oct key",
    mustContain: ["JWKS", "Field breakdown", "Developer snapshot JSON"],
  },
  {
    path: "/en/tools/openapi-breaking-change-diff/",
    input: "textarea, input",
    sampleText: "Removed path",
    mustContain: ["OpenAPI", "Field breakdown", "Developer snapshot JSON"],
  },
  {
    path: "/en/tools/json-patch-builder/",
    input: "textarea, input",
    sampleText: "Risky remove",
    mustContain: ["JSON", "Field breakdown", "Developer snapshot JSON"],
  },
  {
    path: "/en/tools/json-merge-patch-builder/",
    input: "textarea, input",
    sampleText: "Null delete",
    mustContain: ["JSON", "Field breakdown", "Developer snapshot JSON"],
  },
  {
    path: "/en/tools/rest-pagination-contract-tester/",
    input: "textarea, input",
    sampleText: "Offset risk",
    mustContain: ["REST", "Field breakdown", "Developer snapshot JSON"],
  },
  {
    path: "/en/tools/api-error-code-catalog-builder/",
    input: "textarea, input",
    sampleText: "Thin errors",
    mustContain: ["API", "Field breakdown", "Developer snapshot JSON"],
  },
  {
    path: "/en/tools/webhook-replay-payload-builder/",
    input: "textarea, input",
    sampleText: "Thin event",
    mustContain: ["Webhook", "Field breakdown", "Developer snapshot JSON"],
  },
  {
    path: "/en/tools/idempotency-collision-lab/",
    input: "textarea, input",
    sampleText: "Collision",
    mustContain: ["Idempotency", "Field breakdown", "Developer snapshot JSON"],
  },
  {
  ...
  {
    path: "/en/tools/canonical-hreflang-auditor/",
    input: "textarea, input",
    sampleText: "Mixed host",
    mustContain: ["Canonical", "Field breakdown", "Developer snapshot JSON"],
  },
  {
    path: "/en/tools/search-snippet-preview/",
    input: "textarea, input",
    sampleText: "Thin snippet",
    mustContain: ["Search", "Field breakdown", "Developer snapshot JSON"],
  },
  {
    path: "/en/tools/structured-data-json-ld-validator/",
    input: "textarea, input",
    sampleText: "Bad JSON-LD",
    mustContain: ["Structured", "Field breakdown", "Developer snapshot JSON"],
  },
  {
    path: "/en/tools/csv-schema-inferencer/",
    input: "textarea, input",
    sampleText: "Ragged CSV",
    mustContain: ["CSV", "Field breakdown", "Developer snapshot JSON"],
  },
  {
    path: "/en/tools/duplicate-row-detector/",
    input: "textarea, input",
    sampleText: "Clean list",
    mustContain: ["Duplicate", "Field breakdown", "Developer snapshot JSON"],
  },
  {
    path: "/en/tools/unicode-confusable-scanner/",
    input: "textarea, input",
    sampleText: "Normal text",
    mustContain: ["Unicode", "Field breakdown", "Developer snapshot JSON"],
  },
  {
    path: "/en/tools/locale-number-parser/",
    input: "textarea, input",
    sampleText: "Mixed separators",
    mustContain: ["Locale", "Field breakdown", "Developer snapshot JSON"],
  },
  {
    path: "/en/tools/locale-date-parser/",
    input: "textarea, input",
    sampleText: "Invalid date",
    mustContain: ["Locale", "Field breakdown", "Developer snapshot JSON"],
  },
  {
    path: "/en/tools/luhn-card-fixture-generator/",
    input: "textarea, input",
    sampleText: "Bad Luhn",
    mustContain: ["Card", "Field breakdown", "Developer snapshot JSON"],
  },
  {
    path: "/en/tools/bin-iin-shape-inspector/",
    input: "textarea, input",
    sampleText: "Full PAN risk",
    mustContain: ["BIN", "Field breakdown", "Developer snapshot JSON"],
  },
  {
    path: "/en/tools/currency-minor-units-checker/",
    input: "textarea, input",
    sampleText: "Bad precision",
    mustContain: ["Currency", "Field breakdown", "Developer snapshot JSON"],
  },
  {
    path: "/en/tools/sepa-pain001-fixture-helper/",
    input: "textarea, input",
    sampleText: "Thin payment",
    mustContain: ["SEPA", "Field breakdown", "Developer snapshot JSON"],
  },
  {
    path: "/en/tools/payment-reference-generator/",
    input: "textarea, input",
    sampleText: "Ambiguous free text",
    mustContain: ["Payment", "Field breakdown", "Developer snapshot JSON"],
  },
  {
    path: "/en/tools/password-policy-tester/",
    input: "textarea, input",
    sampleText: "Weak sample",
    mustContain: ["Password", "Field breakdown", "Developer snapshot JSON"],
  },
  {
    path: "/en/tools/csp-nonce-hash-helper/",
    input: "textarea, input",
    sampleText: "Unsafe policy",
    mustContain: ["CSP", "Field breakdown", "Developer snapshot JSON"],
  },
  {
    path: "/en/tools/cookie-samesite-lab/",
    input: "textarea, input",
    sampleText: "Third-party risk",
    mustContain: ["Cookie", "Field breakdown", "Developer snapshot JSON"],
  },
  {
    path: "/en/tools/email-header-auth-inspector/",
    input: "textarea, input",
    sampleText: "Failing headers",
    mustContain: ["Email", "Field breakdown", "Developer snapshot JSON"],
  },
  {
    path: "/en/tools/log-redaction-rule-tester/",
    input: "textarea, input",
    sampleText: "Clean log",
    mustContain: ["Log", "Field breakdown", "Developer snapshot JSON"],
  },
